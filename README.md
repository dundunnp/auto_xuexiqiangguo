...
# v5.0 更新内容:
1. 增加关于四人赛双人对战的配置选项，由于描述字数有限请看[副脚本](https://hamibot.com/marketplace/sp1Lc)如何配置
2. 修复答题错误重新答题时错误进去强国商场的bug
3. 修复专项答题无法完成的bug
...
## v4.0 更新内容:
1. 优化每题间隔时间、利用双题库, 极大改善四人赛、双人对战的速度和正确率
2. 修复部分机型卡在首页无法点击“我的”
## v3.3 更新内容:
1. 改善四人赛、双人对战正确率
...
1. 修复挑战答题错误bug
## v3.0 更新内容:
1. 增加两个配置选项，对于每周答题和专项答题，如果有已经将之前答题全部完成的小伙伴，将不会再向下搜索（需要配置是，默认选择否）
2. 由于软件更新原因，四人赛和双人对战也需要ocr，挑战答题不受影响
3. 修复点击“我的”时跳转到搜索框bug
## v2.1 更新内容:
